...
typedef struct PJ_filter_registry_vtable_t {
  ...
  bool (*register_transform)(
      void* ctx, PJ_filter_transform_registration_t reg, void* library_owner, PJ_error_t* out_error) PJ_NOEXCEPT;
   ...
   * Thread-class: [thread-safe]
   */
  PJ_filter_transform_t* (*create_transform)(void* ctx, PJ_string_view_t id, PJ_error_t* out_error)PJ_NOEXCEPT;
   ...
   * Thread-class: [thread-safe]
   */
  void (*list_ids)(void* ctx, PJ_string_view_t* out_ids, size_t capacity, size_t* out_count) PJ_NOEXCEPT;
